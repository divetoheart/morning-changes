...
export function AutumnPortFooter({ study: _study, onSwitchKey }: { study: StudyKey; onSwitchKey: (keyId: string) => void }) {
  return <>
    <ThreeForHeadphones
      ...
      picks={[
        { meta:'1958 · Somethin’ Else', title:'Autumn Leaves', artist:'Cannonball Adderley featuring Miles Davis', note:'The G minor / B-flat major modern-jazz reference: Miles’s spacious statement, Adderley’s alto, and a lesson in playing the form without crowding it.', href:'https://www.youtube.com/watch?v=u37RF5xKNq8', keyLabel:'Gm / B♭', onSwitchKey:() => onSwitchKey('gm-bb') },
        { meta:'1959 / released 1960 · Portrait in Jazz', title:'Autumn Leaves', artist:'Bill Evans Trio', note:'A trio reference for conversation, comping space, and a rhythm section that moves as one line. The linked E minor / G major study is a guitar-friendly translation of that listening world.', href:'https://www.youtube.com/watch?v=r-Z8KuwI7Gc', keyLabel:'Em / G', onSwitchKey:() => onSwitchKey('em-g') },
        { meta:'2010 · Clapton', title:'Autumn Leaves', artist:'Eric Clapton', note:'A vocal, guitar-forward reading from Clapton’s 2010 album. The B minor / D major option is the dedicated guitar study key for this reference.', href:'https://www.youtube.com/results?search_query=Eric+Clapton+Autumn+Leaves+Clapton+2010', keyLabel:'Bm / D', onSwitchKey:() => onSwitchKey('bm-d') }
      ]}
    />
